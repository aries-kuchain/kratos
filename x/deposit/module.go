...
import (
	...
	"github.com/KuChainNetwork/kuchain/x/deposit/client/cli"
	"github.com/KuChainNetwork/kuchain/x/deposit/client/rest"
	"github.com/KuChainNetwork/kuchain/x/deposit/keeper"
	"github.com/KuChainNetwork/kuchain/x/deposit/simulation"
...
func NewAppModule(keeper keeper.Keeper, ak types.AccountKeeper, bk types.BankKeeper, sk types.SupplyKeeper) AppModule {
	return AppModule{
...
// RegisterInvariants registers the deposit module invariants.
